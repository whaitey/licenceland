...
require __DIR__ . '/includes/plugin-update-checker/Puc/v5p6/Autoloader.php';
new Autoloader();

require __DIR__ . '/includes/plugin-update-checker/Puc/v5p6/PucFactory.php';
require __DIR__ . '/includes/plugin-update-checker/Puc/v5/PucFactory.php';
